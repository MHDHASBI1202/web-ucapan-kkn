/**
 * data.js — Member data and farewell messages
 * Setiap objek berisi: username, password, name, nickname,
 * salutation, letterBody (array paragraf), memories, quote
 *
 * Username format : anggota1 – anggota19  |  umum
 * Password        : kkn2024  (universal)
 */
...
const MEMBERS = [
  ...
  —————————————————————————————— */
  {
    ...
    password: "kkn2024",
    name: "Keluarga KKN",
    nickname: "Kalian yang Tak Tergantikan",
    salutation: "Untuk Kalian Semua,",
    letterBody: [
  ...
  —————————————————————————————— */
  {
    ...
    memories: [
      ...
      { icon: "🎭", text: "Drama spontanmu saat program berlangsung — tak terduga tapi selalu menghibur" },
  ...
  —————————————————————————————— */
  {
    ...
    quote: "Kepemimpinan yang sejati tidak diukur dari seberapa banyak pengikutmu, tapi seberapa besar kamu menumbuhkan mereka."
  },

  /* ——————————————————————————————
     ANGGOTA 7  (username: anggota7)
  —————————————————————————————— */
  {
    username: "anggota7",
    password: "kkn2024",
    ...
    quote: "Empati adalah jembatan yang menghubungkan satu hati ke hati yang lain — dan kamu membangunnya dengan begitu indah."
  },

  /* ——————————————————————————————
     ANGGOTA 8  (username: anggota8)
  —————————————————————————————— */
  {
    username: "anggota8",
    password: "kkn2024",
    ...
    letterBody: [
      ...
      "Kerja kerasmu akan berbuah. Tidak hari ini, mungkin tidak besok — tapi akan datang masanya. Dan hari itu, kamu akan tersenyum dan tahu bahwa setiap usahanya tidak sia-sia."
    ],
    memories: [
  ...
  —————————————————————————————— */
  {
    ...
    memories: [
      ...
      { icon: "🎪", text: "Saat program terasa membosankan, kamu yang mengubah segalanya dengan satu gagasan" },
      { icon: "🖌️", text: "Sentuhan estetikamu yang membuat setiap output tampak jauh lebih bermakna" }
    ],
    quote: "Kreativitas adalah memberi kehidupan baru pada hal-hal yang sudah ada."
  },

  /* ——————————————————————————————
     ANGGOTA 12  (username: anggota12)
  —————————————————————————————— */
  {
    username: "anggota12",
    password: "kkn2024",
  ...
  —————————————————————————————— */
  {
    ...
    memories: [
      { icon: "📸", text: "Cara kamu selalu mendokumentasikan momen-momen yang terasa biasa tapi ternyata bermakna" },
